...
try {
    ...
    if (!isset($data['lesson_id']) || !isset($data['teacher_id'])) {
        throw new Exception("Ders ID ve Eğitmen ID gerekli");
    }
    ...
    echo json_encode([
        ...
        'message' => "Ders için {$affectedCount} kişiye eğitmen atandı"
    ]);

} catch (Exception $e) {
    error_log("Ders eğitmen atama hatası: " . $e->getMessage());
    echo json_encode([
        'success' => false,
